...
public class ScheduledSOSY {
    public static List<ScheduledCourse> getAllScheduledCourses() {
        ...
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()), "CMPT 130", "Dr. CMPT", "Location 1"));
        ...
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()),"CMPT 135", "Dr. CMPT", "Location 1"));
        ...
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()),"CMPT 105w", "Dr. WRITE", "Location 2"));
        ...
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()),"CMPT 376w", "Dr. WRITE", "Location 1"));
            scheduledCourses.get(scheduledCourses.size()-1).addLecture("Location 1", "Tuesday", 1000, 1500);
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()),"MATH 151", "Dr. MATH", "Location 1"));
            scheduledCourses.get(scheduledCourses.size()-1).addLecture("Location 1", "Monday", 1000, 1100);
        ...
        scheduledCourses.add(new ScheduledCourse(String.valueOf(scheduledCourses.size()),"MATH 152", "Dr. MATH", "Location 1"));
