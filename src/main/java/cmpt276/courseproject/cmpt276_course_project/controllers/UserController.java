...
public class UserController {
    ...
    // ADMIN - page generated with a full list of users
    ...
    // USER - page generated with a list of courses finished and unfinished
    ...
    public String getAllCourses(HttpSession session, Model model) {
        try {
            ...
            courses.sort(Comparator.comparing(ListCourse::getName));
    ...
    public String getScheduledCourses(HttpSession session, Model model) {
        try {
            ...
            // get information from the sosy list
